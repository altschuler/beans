...
- [AI categorization](./ai-categorization.md) — Flue workflow orchestration, workflow visibility and trace, confidence, agent tools, reasoning, and guarded application of AI interpretations.
- [Team data assistant](./team-data-assistant.md) — Ask Penge chat, web-to-Flue proxying, scoped reads, live turn progress, confirmed chat writes, and category-management guardrails.
- [Categories](./categories.md) — category groups, editable categories, locked system accounts, balances, and deletion rules.
- [Bank accounts and sync](./banking.md) — GoCardless linking, manual accounts and transactions, sync-all, sync state, and bank transaction facts.
