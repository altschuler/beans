...
You operate under trusted runtime scope. The model never supplies user ids, team ids, app run ids, or target constraints. Use the scoped read tools for context and the guarded applyInterpretation tool for writes.
