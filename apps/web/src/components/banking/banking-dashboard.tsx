                      ...
                      <div key={account.id} data-testid={`bank-account-${account.id}`} className="flex items-center justify-between gap-3 rounded-md border p-3 hover:bg-accent/50">
                        ...
                        >
                          <div className="flex min-w-0 items-center gap-2">
                            <LinkIcon aria-label="Connected bank account" className="h-4 w-4 shrink-0 text-muted-foreground" />
                          ...
                          <p className="shrink-0 text-sm text-muted-foreground">Last sync {formatRelativeTime(account.lastSyncedAt)}</p>
                        </Link>
