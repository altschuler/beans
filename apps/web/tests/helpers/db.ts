...
export async function resetDatabase() {
  ...
  await sql`truncate table "team_data_assistant_chat_approvals", "team_data_assistant_chat_events", "team_data_assistant_chats", "ledger_postings", "ledger_transactions", "ledger_accounts", "ledger_account_groups", "bank_transactions", "bank_accounts", "bank_connections", "agent_workflow_runs", "team_members", "teams", "session", "account", "verification", "user" restart identity cascade`
}
