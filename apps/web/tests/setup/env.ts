...
process.env.ZERO_QUERY_URL ??= 'https://localhost:3100/api/zero/query'
process.env.ZERO_MUTATE_URL ??= 'https://localhost:3100/api/zero/mutate'
...
process.env.VITE_PUBLIC_APP_URL ??= 'https://localhost:3100'
process.env.BETTER_AUTH_SECRET ??= 'dev-secret-change-me-at-least-32-characters'
process.env.BETTER_AUTH_URL ??= 'https://localhost:3100'
